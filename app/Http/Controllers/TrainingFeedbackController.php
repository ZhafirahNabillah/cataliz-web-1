...
use App\Models\Training_feedback;
...
class TrainingFeedbackController extends Controller
{
    ...
    {
        //
        $training_feedback = new Training_feedback;
        $training_feedback->result_id = $request->result_id;
        ...
        return response()->json($training_feedback);
    }
