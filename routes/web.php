...
Route::post('/docs/coach_docs', [DocumentationController::class, 'coach_docs'])->name('docs.coach_docs');
Route::post('/docs/coachee_docs', [DocumentationController::class, 'coachee_docs'])->name('docs.coachee_docs');
