                                                        ...
                                                        <div class="card-body">
                                                            <ul class="list-group list-group-flush">
                                                                <li class="list-group-item">
                                                                    {{strtoupper($data->batchs->program->program_name)}} ( Batch {{$data->batchs->batch_number}} )</li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="accordion" id="accordionExample">
                                                <div class="card border">
                                                    ...
                                                    <div id="collapse1" role="tabpanel" aria-labelledby="headingCollapse1" class="collapse show" data-parent="#accordionExample">
                                                        <div class="card-body">
                                                            <ul class="list-group list-group-flush">
                                                                <li class="list-group-item">{{strtoupper($data->bank)}}
                                                                </li>
                                                            </ul>
                                                            <ul>
                                            ...
                                            <div class="accordion" id="accordionExample">
                                                <div class="card border">
                                                    ...
                                                    <div id="collapse1" role="tabpanel" aria-labelledby="headingCollapse1" class="collapse show" data-parent="#accordionExample">
                                                        <div class="card-body">
                                                            <ul class="list-group list-group-flush">
                                                                <li class="list-group-item">{{ucwords($data->status)}}
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </div>
