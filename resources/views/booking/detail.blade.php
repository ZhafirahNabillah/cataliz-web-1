            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="content-body">
                        ...
                        <div class="card border">
                            <div class="card body">
                            <h6>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis ornare facilisis nulla et consequat. Vivamus vulputate, est vel pulvinar cursus, leo odio vehicula dui, eget consectetur ante velit id orci. Phasellus enim ante, accumsan ut eros non, viverra egestas lectus. Proin in metus sollicitudin,</h6>
                            </div>
                        </div>
                        <div class="card border">
                            <div class="card body">
                                            ...
                                            <div class="card-body">
                                                <ul class="list-group list-group-flush">
                                                    <li class="list-group-item">Lorem ipsum dolor sit amet, consectetur
                                                        adipiscing elit. Duis ornare facilisis nulla et consequat.
                                                        Vivamus vulputate, est vel pulvinar cursus, leo odio vehicula
                                                        dui, eget consectetur ante velit id orci. Phasellus enim ante,
                                                        accumsan ut eros non, viverra egestas lectus. Proin in metus
                                                        sollicitudin,</li>
                                                </ul>
                                            </div>
                                        </div>
