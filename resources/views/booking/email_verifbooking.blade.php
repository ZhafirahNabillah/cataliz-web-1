      ...
      <tr>
        <td valign="top" class="em_aside">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td align="left" style="font-family:'Open Sans', Arial, sans-serif; font-size:15px; font-weight:bold; color:black; padding-left:30px; padding-right:30px;">Dear client, Cataliz would like to remind you that the session will be held with the following schedule :</td>
            </tr>
            <tr>
              <td height="10" style="font-size:1px; line-height:1px;">&nbsp;</td>
            </tr>
