  ...
  <div class="content-wrapper">
    ...
    <div class="content-body">
      ...
      <div class="">
        ...
        <button style="margin-top: 10px;margin-bottom: 10px;" type="submit"
          class="btn btn-danger data-submit mr-1 deleteAllPermanently">Delete Permanently</button>
      </div>
      <div class="card">
        <div class="card-body">
        ...
        $(function() {
          ...
          $('body').on('click', '.deletePermanently', function() {
            Swal.fire({
              ...
              text: "User and their coaching data will be deleted and never can't be restored, please be noted!",
              icon: "warning",
              showCancelButton: true,
              confirmButtonColor: "#DD6B55",
              confirmButtonText: "Yes, Sure",
              ...
              if (result.isConfirmed) {
                var user_id = $(this).data('id');
                  $.ajax({
                    type: "POST",
                    url: "" + '/delete_user_permanently/' + user_id,
                    success: function(data) {
                      Swal.fire({
                        icon: 'success',
          ...
          $('body').on('click', '.deleteAllPermanently', function() {
            Swal.fire({
              title: "Are you sure to delete permanently?",
              text: "All user and their coaching data will be deleted and never can't be restored, please be noted!",
              icon: "warning",
              showCancelButton: true,
              confirmButtonColor: "#DD6B55",
              confirmButtonText: "Yes, Sure",
              ...
              if (result.isConfirmed) {
                  $.ajax({
                    type: "POST",
                    url: "" + '/delete_all_permanently',
                    success: function(data) {
                      Swal.fire({
                        icon: 'success',
                        title: 'All user delete permanently!',
                      });
                      table_coach.draw();
                      table_admin.draw();
                      table_coachee.draw();
