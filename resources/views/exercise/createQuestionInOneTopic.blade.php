...
<div class="app-content content ">
    ...
    <div class="content-wrapper">
                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                {{-- <li class="breadcrumb-item "><a href="{{route('exercise.show')}}"></a> Detail Exam
                                </li> --}}
        ...
        <div class="row">
            <div class="col-lg-12">
                <form action="{{ route('question.store_new', $id) }}" method="post">
                    @csrf
                    <div class="card mb-1">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="question-1" id="question-1"
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control col-sm-6" id="true_answer" name="true-answer-1">
