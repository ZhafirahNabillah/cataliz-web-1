    ...
    <div class="card">
      <div class="card-body">
        ...
        <ul class="nav nav-tabs justify-content-center" role="tablist">
          ...
          <li class="nav-item">
            <a class="nav-link @if ($loop->first) active @endif" id="{{ $role->name }}-tab" data-toggle="tab"
              href="#{{ $role->name }}" role="tab">{{ ucfirst($role->name) }}</a>
          </li>
          @endforeach
        </ul>
        <div class="tab-content">
          @foreach ($roles as $role)
          <div class="tab-pane @if ($loop->first) active @endif" id="{{ $role->name }}" aria-labelledby="coach-tab"
            role="tabpanel">
            <div class="row">
              <div class="col-12">
        ...
        <div class="card">
          <div class="card-body">
            <ul class="nav nav-tabs justify-content-center" role="tablist">
              ...
              <li class="nav-item">
                <a class="nav-link" id="profile-tab" data-toggle="tab" href="#trainer" aria-controls="profile"
                  role="tab" aria-selected="false">Trainer</a>
              </li>
              <li class="nav-item">
