              ...
              <tr>
                <td align="center" valign="top" style="background-color: white;">
                  ...
                  <table style="margin:0 auto;" cellspacing="0" cellpadding="0" width="100%">
                    ...
                    <tr>
                      <td style="text-align: center;">
                        <h1 style="color: black;margin-top: 20px;margin-left: 15px;font-weight: bold;">New Coach</h1>
                        <span style="margin-left: 15px;color: #656565;">Admin has been assigned you to a new
                          Coach!</span>
                        <br>
                        <!-- link ke agendas -->
