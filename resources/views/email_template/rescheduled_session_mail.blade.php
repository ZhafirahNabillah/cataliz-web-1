            ...
            <tr>
              <td align="center" valign="top" style="background-color: #E9E7FF;">
                ...
                <table style="margin:0 auto;" cellspacing="0" cellpadding="0" width="100%">
                  ...
                  <tr>
                    <td style="text-align: left;">
                      <h1 style="color: black;margin-top: 50px;margin-left: 15px;">Session Rescheduled</h1>
                      <span style="margin-left: 15px;color: #656565;">There’s a session rescheduled for you </span>
                      <br>
            ...
            <tr>
              <td style="background-color:white;">
                ...
                <table cellspacing="0" cellpadding="15px" class="force-full-width">
                  ...
                  <tr>
                    <th colspan="3" style="color: black;">to be for</th>
                  </tr>
                  <tr>
                    <!-- Waktu reschedule -->
                ...
                <table cellspacing="0" cellpadding="0" class="force-full-width">
                  <tr>
                    <span style="color: black;"> We hope that you will attend the rescheduled session with the following
                      details:
                    </span>
                  </tr>
                </table>
                  ...
                  <table style="margin: 0 auto;" cellspacing="0" cellpadding="0" class="force-width-80" width="80%">
                    <tr>
                      <td style="text-align: justify;">
                        <br>
                        <p>You can see a list of all your sessions on the "Agenda" menu in your Cataliz account or
                          click
                          on
                          the button below.</p>
