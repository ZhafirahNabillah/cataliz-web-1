              ...
              <td style="background-color:white;">
                ...
                <table cellspacing="0" cellpadding="0" class="force-full-width">
                  <tr style="text-align: justify;">
                    <!-- Nama user coach -->
                    <h3 style="color: black;">Hi, {{ $email_data['admin_name'] }}</h3>
                    <p style="color: black;">You have been paired a coachee to a coach
                    </p>
                    <span>
                      See your Coachee list bye click on the button bellow {{ $email_data['coach_name'] }} {{ $email_data['client_name'] }}
                    </span>
                  </tr>
                </table>
                <br>
