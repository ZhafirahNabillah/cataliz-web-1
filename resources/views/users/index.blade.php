						...
						<form class="add-new-record modal-content pt-0" id="userForm" name="userForm">
							...
							<div class="modal-body flex-grow-1">
								...
								<div class="form-group">
									...
									<input id="email" name="email" type="text" class="form-control dt-full-name" id="basic-icon-default-email" placeholder="John Doe" aria-label="John Doe" />
								</div>
								<div class="form-group">
									<label class="form-label" for="basic-icon-default-phone">Phone</label>
									<input id="phone" name="phone" type="text" class="form-control dt-full-name" id="basic-icon-default-phone" placeholder="John Doe" aria-label="John Doe" />
								</div>
								<div class="form-group">
