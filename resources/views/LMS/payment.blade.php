...
@section('content')
<!-- BEGIN: Content-->
<div class="app-content content" style="margin-top: -5%; margin-left: -0.5%;background-image:url('/assets/images/bg_paymentLMS.png'); background-size: cover; background-position: center center;">
    <!-- Mask & flexbox options-->
    <div class="container-fluid">
        <div class="row justify-content-center align-items-center">
            <div class="card" style="background-color: #fffff; border-radius: 15px 15px 15px 15px;">
                ...
                @endif
                <div class="container">
                    <h3 class="text-center font-weight-bolder" style="font-family: Montserrat; color:#7367F0; font-size: 200%">PAYMENT</h3>
                    <p class="text-center font-weight-bolder" style="font-family: Montserrat; color:black; font-size:125%">  </p>
                    <dl class="text-center" style="font-family: Montserrat; color:black; font-size: 105%">
                        <dt class="font-weight-bold">YOUR CODE BOOKING : </dt>
                        <dt>Total : Rp. </dt>
                        <dt>Transfer To : </dt>
                    </dl>
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row-3">
                        <div class="mt-2 mb-2">
                            ...
                            <input type="hidden" class="text" name="program" value="">
                            <div class="row-3">
                                <div class="row justify-content-center align-items-center">
                ...
                <img class="img-fluid" src="{{asset('assets/images/bank_paymentLMS.png')}}" alt="" />
            </div>
        </div>
    </div>
</div>
