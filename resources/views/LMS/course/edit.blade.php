          ...
          <div class="card p-2">
            <form action="{{ route('docs.store') }}" method="post">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                <label for="title">Sub Program</label>
          ...
          <div class="card p-2">
            <form action="{{ route('docs.store') }}" method="post">
              ...
              <div class="form-group">
                ...
                <div style="width:100%;height:250px;border:1px solid #C4C4C4;padding:10px; border-radius:5px; text-align:center; padding: 35px 15px 35px 15px;">
                  <img src="{{ url('/assets/images/upload.png') }}" style="width:116.36px; height:80px;">
                  <center style="font-family:roboto; font-weight:normal; font-size:14px; font-color:#656565;">Drag and Drop File Here</center>
                  <center style="font-family:roboto; font-weight:normal; font-size:14px; font-color:#656565;">Or</center>
