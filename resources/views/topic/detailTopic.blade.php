        ...
        <div class="col-12">
          <div class="card">
            <ul class="nav nav-tabs justify-content-center pt-1" role="tablist">
              <li class="nav-item">
                <a class="nav-link active" id="profile-tab" data-toggle="tab" href="#sub-topic" aria-controls="profile"
                  role="tab" aria-selected="false">Sub Topic</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" id="coach-tab" data-toggle="tab" href="#participant" aria-controls="coach"
                        ...
                        <div class="collapse-default sub-topic-wrapper">
                          ...
                          <div class="card" id="{{ $sub_topic->id }}">
                            ...
                            <div id="sub-topic-{{ $sub_topic->id }}" role="tabpanel" class="collapse">
                              <div class="card-body">
                                <div class="text-left">
                                  <button type="button" class="btn btn-primary create-lesson-btn mb-1"
                                    data-toggle="modal" data-id="{{ $sub_topic->id }}">
                                    New Materi
                                  </button>
                                </div>
                                <div class="lesson-wrapper-{{ $sub_topic->id }}">
                                  ...
                                  <div class="row mb-1 align-items-center lesson-{{ $lesson->id }}">
                                    ...
                                    <div class="col-sm-4">
                                      <button type="button" class="btn btn-sm btn-primary playLessonBtn"
                                        data-id="{{ $lesson->id }}" data-toggle="modal">Play</button>
                      ...
                      <div class="modal-body">
                        <form class="create-sub-topic-form">
                          <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="sub_topic"
                              placeholder="Your Sub Topic Here...">
