...
<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            @can('list-topic')
            <li class="nav-item ">
                <a class="d-flex align-items-center" href=""><i data-feather="file-text"></i><span class="menu-title text-truncate" data-i18n="Todo">Topic</span></a>
            </li>
            @endcan
            @can('list-exercise')
            <li class="nav-item ">
                <a class="d-flex align-items-center" href=""><i data-feather="copy"></i><span class="menu-title text-truncate" data-i18n="Todo">Exercise</span></a>
            </li>
            @endcan
            ...
            @role('admin')
            <li class=" navigation-header"><span data-i18n="Apps &amp; Pages">Others</span><i data-feather="more-horizontal"></i></li>
            <li class=" nav-item {{ 'docs' == request()->path() ? 'active' : '' }}">
                <a class="d-flex align-items-center" href="{{route('docs.index')}}"><i data-feather="inbox"></i><span class="menu-title text-truncate" data-i18n="Email">Documentations</span></a>
            </li>
            @endrole
